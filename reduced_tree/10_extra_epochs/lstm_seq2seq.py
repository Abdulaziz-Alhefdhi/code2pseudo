...
model = load_model('../c2p_att_redtr_20.h5')
# Compile & run training
model.compile(optimizer='rmsprop', loss='categorical_crossentropy', metrics=['acc'])
# Save model after each epoch
checkpointer = ModelCheckpoint(filepath= 'checkpoints/c2p_att_redtr_30-{epoch:02d}.hdf5', verbose=1)
...
# Save model
model.save('c2p_att_redtr_30.h5')
