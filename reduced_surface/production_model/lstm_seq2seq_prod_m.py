...
path_to_train_data = '/home/aa043/sea/data/code2pseudo/reduced_surface/train/'
path_to_test_data = '/home/aa043/sea/data/code2pseudo/reduced_surface/test/'
...
model = load_model('/home/aa043/sea/trained_models/code2pseudo/reduced_surface/c2p_att_redsurf.h5')
print("Model file name: c2p_att_redsurf.h5")
print("================")
...
for seq_index in tqdm(range(sample_limit)):
    ...
    with open("/home/aa043/sea/output/code2pseudo/reduced_surface/testing_output", "a") as f:
