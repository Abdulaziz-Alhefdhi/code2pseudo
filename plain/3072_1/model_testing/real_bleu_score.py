...
print("Bleu score:", corpus_bleu(refs, predicted_lists))
print("Bleu score:", corpus_bleu(refs, predicted_lists, weights=(1., 0., 0., 0.)))
print("Bleu score:", corpus_bleu(refs, predicted_lists, weights=(0.5, 0.5, 0., 0.)))
print("Bleu score:", corpus_bleu(refs, predicted_lists, weights=(0.33, 0.33, 0.33, 0.)))
print("Bleu score:", corpus_bleu(refs, predicted_lists, weights=(0.25, 0.25, 0.25, 0.25)))
