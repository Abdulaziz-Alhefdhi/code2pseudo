...
latent_dim = 2084     # Latent dimensionality of the encoding space.
...
model = load_model("c2p_att_plain_scaled_30.h5")
# Compile & run training
model.compile(optimizer='rmsprop', loss='categorical_crossentropy', metrics=['acc'])
# Save model after each epoch
checkpointer = ModelCheckpoint(filepath= 'checkpoints/c2p_att_plain_scaled_extra_30plus-{epoch:02d}.hdf5', verbose=1)
###checkpointer = ModelCheckpoint(
   ### filepath='/home/aa043/sea/trained_models/code2pseudo/reduced_surface/checkpoints/c2p_att_redsurf-{epoch:02d}.hdf5',
    ###verbose=1)
...
# Save model
model.save('c2p_att_plain_scaled_40.h5')
