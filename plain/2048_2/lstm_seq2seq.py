...
model_name = 'c2p_att_plain_2l-25.hdf5'
model = load_model('checkpoints/'+model_name)
print(model_name)
# Compile & run training
model.compile(optimizer='rmsprop', loss='categorical_crossentropy', metrics=['acc'])
# Save model after each epoch
checkpointer = ModelCheckpoint(filepath= 'checkpoints/c2p_att_plain_2l_25plus-{epoch:02d}.hdf5', verbose=1)
...
# Save model
model.save('c2p_att_plain_2l.h5')
