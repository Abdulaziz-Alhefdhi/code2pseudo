...
model_name = 'c2p_no_att_plain_3072-07plus03.hdf5'
model = load_model('checkpoints/'+model_name)
print("model name:", model_name)
# Compile & run training
model.compile(optimizer='rmsprop', loss='categorical_crossentropy', metrics=['acc'])
# Save model after each epoch
checkpointer = ModelCheckpoint(filepath= 'checkpoints/c2p_no_att_plain_3072-07plus03plus{epoch:02d}.hdf5', verbose=1)
model.summary()
...
# Save model
model.save('c2p_no_att_plain_3072.h5')
