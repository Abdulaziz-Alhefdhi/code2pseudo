...
###data_path = '/home/aa043/sea/data/code2pseudo/train/'  # Path to the data txt files on disk.
...
checkpointer = ModelCheckpoint(filepath= 'checkpoints/c2p_seq_att-{epoch:02d}.hdf5', verbose=1)
# Note that 'decoder_target_data' needs to be one-hot encoded, rather than sequences of integers like 'decoder_input_data'!
###model.fit([encoder_input_data, decoder_input_data], decoder_target_data, batch_size=batch_size, epochs=epochs, callbacks=[checkpointer], validation_split=0.2)
